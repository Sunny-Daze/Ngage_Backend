...
const joinRecreation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let recreation = yield trainingUserMap_model_1.TrainingUserMapModel.create({
            user,
            recreationId,
        });
        if (recreation) {
...
const updateUserrecreationMilestoneStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let recreation = yield trainingUserMap_model_1.TrainingUserMapModel.findOneAndUpdate({
            milestoneId,
            user,
        }, {
            status,
